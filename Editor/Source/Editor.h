...
#include <Index/Maths/Ray.h>
#include <Index/Maths/Transform.h>
#include <Index/Utilities/IniFile.h>
...
#define BIND_FILEBROWSER_FN(fn) [this](auto&&... args) -> decltype(auto) { \
    ...
    protected:
        ...
        SharedPtr<Graphics::Texture2D> INDEXHeaderLogo;
        SharedPtr<Graphics::Texture2D> WelcomeIndexLogo;
        SharedPtr<Graphics::Texture2D> LargeIndexIconLogo;
        SharedPtr<Graphics::Texture2D> IndexBasicsIcon;
        SharedPtr<Graphics::Texture2D> IndexAnswersIcon;
        SharedPtr<Graphics::Texture2D> IndexForumsIcon;
        SharedPtr<Graphics::Texture2D> IndexAssteStoreIcon;
        SharedPtr<Graphics::Texture2D> VideoPlayerIcon;
