...
namespace Index
{
    ...
    {
        m_Name       = ICON_MDI_TIMER "Profiler";
    ...
    void ProfilerPanel::OnImGui()
    {
        ...
        if(ImGui::Begin(m_Name.c_str(), &m_Active, flags))
        {
            ...
            // m_FPSData.push_back(Index::Engine::Get().Statistics().FramesPerSecond);
            ...
            // if (frame > (int)(ImGui::GetIO().Framerate / 60))
            {
                ...
                rdata1.AddPoint(t, Index::Engine::GetTimeStep().GetMillis()); // 1000.0f / ImGui::GetIO().Framerate);
            }
