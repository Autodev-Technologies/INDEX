...
namespace Index
{
    namespace StringUtilities
    {
        ...
        std::vector<std::string> INDEX_EXPORT SplitString(const std::string& string, const std::string& delimiters);
        std::vector<std::string> INDEX_EXPORT SplitString(const std::string& string, const char delimiter);
        std::vector<std::string> INDEX_EXPORT Tokenize(const std::string& string);
