...
namespace Index
{
    ...
    class INDEX_EXPORT Input : public ThreadSafeSingleton<Input>
    {
    ...
    public:
        ...
        bool GetKeyPressed(Index::InputCode::Key key) const { return m_KeyPressed[int(key)]; }
        bool GetKeyHeld(Index::InputCode::Key key) const { return m_KeyHeld[int(key)]; }
        bool GetMouseClicked(Index::InputCode::MouseKey key) const { return m_MouseClicked[int(key)]; }
        bool GetMouseHeld(Index::InputCode::MouseKey key) const { return m_MouseHeld[int(key)]; }

        void SetKeyPressed(Index::InputCode::Key key, bool a) { m_KeyPressed[int(key)] = a; }
        void SetKeyHeld(Index::InputCode::Key key, bool a) { m_KeyHeld[int(key)] = a; }
        void SetMouseClicked(Index::InputCode::MouseKey key, bool a) { m_MouseClicked[int(key)] = a; }
        void SetMouseHeld(Index::InputCode::MouseKey key, bool a) { m_MouseHeld[int(key)] = a; }
