...
namespace Index
{
    ...
    {
        SetKeyPressed(Index::InputCode::Key(e.GetKeyCode()), e.GetRepeatCount() < 1);
        SetKeyHeld(Index::InputCode::Key(e.GetKeyCode()), true);
        return false;
    }

    bool Input::OnKeyReleased(KeyReleasedEvent& e)
    {
        SetKeyPressed(Index::InputCode::Key(e.GetKeyCode()), false);
        SetKeyHeld(Index::InputCode::Key(e.GetKeyCode()), false);
        return false;
    }

    bool Input::OnMousePressed(MouseButtonPressedEvent& e)
    {
        SetMouseClicked(Index::InputCode::MouseKey(e.GetMouseButton()), true);
        SetMouseHeld(Index::InputCode::MouseKey(e.GetMouseButton()), true);
        return false;
    }

    bool Input::OnMouseReleased(MouseButtonReleasedEvent& e)
    {
        SetMouseClicked(Index::InputCode::MouseKey(e.GetMouseButton()), false);
        SetMouseHeld(Index::InputCode::MouseKey(e.GetMouseButton()), false);
        return false;
    }
