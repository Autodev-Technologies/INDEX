...
namespace Index
{
    ...
    public:
        ...
        ResourceHandle GetResource(const IDType& name)
        {
            ...
            {
                INDEX_LOG_ERROR("Resource Manager could not load resource name {0} of type {1}", name, typeid(T).name());
        ...
        bool ReloadResources()
        {
            ...
            while(itr != m_NameResourceMap.end())
            {
                ...
                {
                    INDEX_LOG_ERROR("Resource Manager could not reload resource name {0} of type {1}", itr->first, typeid(T).name());
                }
                ++itr;
            }
            return true;
