...
static const uint32_t RENDERER_POINT_SIZE        = sizeof(Index::Graphics::PointVertexData) * 4;
...
static const uint32_t RENDERER_LINE_SIZE        = sizeof(Index::Graphics::LineVertexData) * 4;
...
namespace Index::Graphics
{
    ...
    void RenderPasses::BeginScene(Scene* scene)
    {
        ...
        if(renderSettings.Renderer2DEnabled)
        {
            ...
            {
                INDEX_PROFILE_SCOPE("Sort Meshes by distance from camera");
            ...
            {
                INDEX_PROFILE_SCOPE("Sort sprites by z value");
    ...
    {
        INDEX_PROFILE_FUNCTION();
        INDEX_PROFILE_GPU("Render Passes");
    ...
    void RenderPasses::UpdateCascades(Scene* scene, Light* light)
    {
        ...
        for(uint32_t i = 0; i < m_ShadowData.m_ShadowMapNum; i++)
        {
            INDEX_PROFILE_SCOPE("Create Cascade");
    ...
    void RenderPasses::ShadowPass()
    {
        ...
        for(uint32_t i = 0; i < m_ShadowData.m_ShadowMapNum; ++i)
        {
            INDEX_PROFILE_GPU("Shadow Layer Pass");
    ...
    {
        INDEX_PROFILE_FUNCTION();
        INDEX_PROFILE_GPU("Depth Pre Pass");
    ...
    {
        INDEX_PROFILE_FUNCTION();
        INDEX_PROFILE_GPU("SSAO Blur Pass");
    ...
    {
        INDEX_PROFILE_FUNCTION();
        INDEX_PROFILE_GPU("Forward Pass");
    ...
    {
        INDEX_PROFILE_FUNCTION();
        INDEX_PROFILE_GPU("Depth Of Field Pass");
    ...
    {
        INDEX_PROFILE_FUNCTION();
        INDEX_PROFILE_GPU("Sharpen Pass");
    ...
    {
        INDEX_PROFILE_FUNCTION();
        INDEX_PROFILE_GPU("Tone Mapping Pass");
    ...
    {
        INDEX_PROFILE_FUNCTION();
        INDEX_PROFILE_GPU("Debanding Pass");
    ...
    {
        INDEX_PROFILE_FUNCTION();
        INDEX_PROFILE_GPU("Filmic Grain Pass");
    ...
    {
        INDEX_PROFILE_FUNCTION();
        INDEX_PROFILE_GPU("Outline Pass");
    ...
    {
        INDEX_PROFILE_FUNCTION();
        INDEX_PROFILE_GPU("ChromaticAberation Pass");
    ...
    {
        INDEX_PROFILE_FUNCTION();
        INDEX_PROFILE_GPU("Render2D Pass");
        ...
        for(auto entity : textGroup)
        {
...

            {
                ...
                for(int i = 0; i < string.size(); i++)
                {
                    ...
                    {
                        INDEX_PROFILE_SCOPE("Set text buffer data");
