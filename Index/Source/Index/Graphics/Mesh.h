...
namespace Index
{
    namespace Graphics
    {
        ...
        struct INDEX_EXPORT BasicVertex
        {
            glm::vec3 Position;
            glm::vec2 TexCoords;
        };

        struct INDEX_EXPORT Vertex
        {
            Vertex()
...
{
    template <>
    struct hash<Index::Graphics::Vertex>
    {
        size_t operator()(Index::Graphics::Vertex const& vertex) const
        {
