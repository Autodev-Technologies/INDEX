...
namespace Index
{
    namespace Graphics
    {
        ...
        {
            INDEX_ASSERT(CreateFunc, "No Shader Create Function");
        ...
        {
            INDEX_ASSERT(CreateFuncFromEmbedded, "No Shader Create Function");
        ...
        {
            INDEX_ASSERT(CreateCompFuncFromEmbedded, "No Shader Create Function");
            return CreateCompFuncFromEmbedded(compData, compDataSize);
        }

        ShaderDataType Shader::SPIRVTypeToIndexDataType(const spirv_cross::SPIRType type)
        {
            ...
            INDEX_LOG_WARN("Unknown spirv type!");
