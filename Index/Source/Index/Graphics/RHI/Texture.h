...
namespace Index
{
    namespace Graphics
    {
        class INDEX_EXPORT Texture : public Asset
        {
        public:
            virtual ~Texture()
            {
        ...
        class INDEX_EXPORT Texture2D : public Texture
        {
        public:
        ...
        class INDEX_EXPORT TextureCube : public Texture
        {
        protected:
        public:
        ...
        class INDEX_EXPORT TextureDepth : public Texture
        {
        public:
        ...
        class INDEX_EXPORT TextureDepthArray : public Texture
        {
        public:
