...
namespace Index
{
    namespace Graphics
    {
        ...
        RHIFormat Texture::BitsToFormat(uint32_t bits)
        {
            ...
            default:
                INDEX_ASSERT(false, "[Texture] Unsupported image bit-depth! ({0})", bits);
                return RHIFormat::R8G8B8A8_Unorm;
            }
        }
        ...
        {
            INDEX_ASSERT(CreateFunc, "No Texture2D Create Function");
        ...
        {
            INDEX_ASSERT(CreateFromSourceFunc, "No Texture2D Create Function");
        ...
        {
            INDEX_ASSERT(CreateFromFileFunc, "No Texture2D Create Function");
        ...
        {
            INDEX_ASSERT(CreateFunc, "No TextureCube Create Function");
        ...
        {
            INDEX_ASSERT(CreateFromFileFunc, "No TextureCube Create Function");
        ...
        {
            INDEX_ASSERT(CreateFromFilesFunc, "No TextureCube Create Function");
        ...
        {
            INDEX_ASSERT(CreateFromVCrossFunc, "No TextureCube Create Function");
        ...
        {
            INDEX_ASSERT(CreateFunc, "No TextureDepth Create Function");
        ...
        {
            INDEX_ASSERT(CreateFunc, "No TextureDepthArray Create Function");
