...
namespace Index
{
    namespace Graphics
    {
        uint32_t VKUtilities::FindMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties)
        {
            ...
            INDEX_LOG_ERROR("Failed to find suitable memory type!");
            return 0;
        }
                                       ...
                                       VkDeviceMemory& bufferMemory, VmaAllocator allocator, VmaAllocation allocation)
        {
            ...
            {
                INDEX_LOG_ERROR("Failed to allocate buffer memory!");
            }
        ...
        VkPipelineStageFlags AccessFlagsToPipelineStage(VkAccessFlags accessFlags, const VkPipelineStageFlags stageFlags)
        {
            ...
            while(accessFlags != 0)
            {
                ...
                INDEX_ASSERT(AccessFlag != 0 && (AccessFlag & (AccessFlag - 1)) == 0, "Error");
                ...
                default:
                    INDEX_LOG_ERROR("Unknown access flag");
                    break;
                }
            }
            return stages;
        ...
        VkPipelineStageFlags LayoutToAccessMask(const VkImageLayout layout, const bool isDestination)
        {
            ...
            case VK_IMAGE_LAYOUT_UNDEFINED:
                if(isDestination)
                {
                    INDEX_LOG_ERROR("The new layout used in a transition must not be VK_IMAGE_LAYOUT_UNDEFINED.");
                }
                break;
            ...
            case VK_IMAGE_LAYOUT_PREINITIALIZED:
                ...
                {
                    INDEX_LOG_ERROR("The new layout used in a transition must not be VK_IMAGE_LAYOUT_PREINITIALIZED.");
                }
                break;
            ...
            default:
                INDEX_LOG_ERROR("Unexpected image layout");
                break;
            }
                                                  ...
                                                  VkFormatFeatureFlags features)
        {
            ...
            INDEX_LOG_ERROR("Failed to find supported format!");
...
#undef STR
        ...
        VkDescriptorType VKUtilities::DescriptorTypeToVK(DescriptorType type)
        {
            ...
            INDEX_LOG_INFO("Unsupported Descriptor Type");
            return VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER;
        }
        ...
        VkSamplerAddressMode VKUtilities::TextureWrapToVK(const TextureWrap wrap)
        {
            ...
            default:
                INDEX_LOG_CRITICAL("[Texture] Unsupported wrap type!");
                return VK_SAMPLER_ADDRESS_MODE_CLAMP_TO_EDGE;
            }
        }
        ...
        VkFilter VKUtilities::TextureFilterToVK(const TextureFilter filter)
        {
            ...
            case TextureFilter::NONE:
                return VK_FILTER_LINEAR;
            default:
                INDEX_LOG_CRITICAL("[Texture] Unsupported TextureFilter type!");
                return VK_FILTER_LINEAR;
            }
        }
        ...
        VkFormat VKUtilities::FormatToVK(const RHIFormat format, bool srgb)
        {
            if(srgb)
            {
                ...
                default:
                    INDEX_LOG_CRITICAL("[Texture] Unsupported image bit-depth!");
                    return VK_FORMAT_R8G8B8A8_SRGB;
                }
            }
            else
        ...
        RHIFormat VKUtilities::VKToFormat(VkFormat format)
        {
            ...
            default:
                INDEX_LOG_CRITICAL("[Texture] Unsupported texture type!");
                return RHIFormat::R8G8B8A8_Unorm;
            }
        }
        ...
        VkShaderStageFlagBits VKUtilities::ShaderTypeToVK(const ShaderType& shaderName)
        {
            ...
            default:
                INDEX_LOG_CRITICAL("Unknown Shader Type");
                return VK_SHADER_STAGE_VERTEX_BIT;
            }
        }

        VkPolygonMode VKUtilities::PolygonModeToVk(Index::Graphics::PolygonMode mode)
        {
            switch(mode)
            {
            ...
            case Graphics::PolygonMode::POINT:
                ...
                break;
            default:
                INDEX_LOG_CRITICAL("Unknown Polygon Mode");
                return VK_POLYGON_MODE_FILL;
                break;
            }
        }

        VkPrimitiveTopology VKUtilities::DrawTypeToVk(Index::Graphics::DrawType type)
        {
            switch(type)
            {
            ...
            case DrawType::POINT:
                ...
                break;
            default:
                INDEX_LOG_CRITICAL("Unknown Draw Type");
                return VK_PRIMITIVE_TOPOLOGY_TRIANGLE_LIST;
                break;
            }
        }
        ...
        VkPresentModeKHR VKUtilities::ChoosePresentMode(const std::vector<VkPresentModeKHR>& supportedModes, bool vsync)
        {
            ...
            if(!vsync)
            {
                ...
                {
                    INDEX_LOG_ERROR("Failed to find supported presentation mode.");
                }
            }
