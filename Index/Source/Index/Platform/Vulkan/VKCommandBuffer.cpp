...
namespace Index
{
    namespace Graphics
    {
        ...
        {
            INDEX_PROFILE_FUNCTION();
            INDEX_ASSERT(m_Primary, "BeginRecording() called from a secondary command buffer!");
        ...
        {
            INDEX_PROFILE_FUNCTION();
            INDEX_ASSERT(!m_Primary, "BeginRecordingSecondary() called from a primary command buffer!");
            m_State = CommandBufferState::Recording;
        ...
        {
            INDEX_PROFILE_FUNCTION();
            INDEX_ASSERT(m_State == CommandBufferState::Recording, "CommandBuffer ended before started recording");
        ...
        {
            INDEX_PROFILE_FUNCTION();
            INDEX_ASSERT(m_Primary, "Used Execute on secondary command buffer!");
            INDEX_ASSERT(m_State == CommandBufferState::Ended, "CommandBuffer executed before ended recording");
            ...
            {
                INDEX_PROFILE_SCOPE("vkQueueSubmit");
        ...
        {
            INDEX_PROFILE_FUNCTION();
            INDEX_ASSERT(!m_Primary, "Used ExecuteSecondary on primary command buffer!");
            m_State = CommandBufferState::Submitted;
        ...
        {
            INDEX_PROFILE_FUNCTION();
            INDEX_ASSERT(m_State == CommandBufferState::Submitted, "");
