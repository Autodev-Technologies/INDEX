...
namespace Index
{
    namespace Graphics
    {
        ...
        public:
            ...
            {
                INDEX_ASSERT(index < m_PushConstants.size(), "Push constants out of bounds");
            ...
            std::vector<PushConstant>& GetPushConstants() override
            {
                ...
                if(m_PushConstants.empty())
                    INDEX_LOG_WARN("No push constants found in shader");
#endif
            ...
            DescriptorSetInfo GetDescriptorInfo(uint32_t index) override
            {
                ...
                INDEX_LOG_WARN("DescriptorDesc not found. Index = {0}", index);
