...
namespace Index
{
    namespace WindowsKeyCodes
    {
        ...
        inline Index::InputCode::Key WindowsKeyToIndex(uint32_t key)
        {
            static std::map<uint32_t, Index::InputCode::Key> keyMap = {
                { KEYBOARD_A, Index::InputCode::Key::A },
                { KEYBOARD_B, Index::InputCode::Key::B },
                { KEYBOARD_C, Index::InputCode::Key::C },
                { KEYBOARD_D, Index::InputCode::Key::D },
                { KEYBOARD_E, Index::InputCode::Key::E },
                { KEYBOARD_F, Index::InputCode::Key::F },
                { KEYBOARD_G, Index::InputCode::Key::G },
                { KEYBOARD_H, Index::InputCode::Key::H },
                { KEYBOARD_I, Index::InputCode::Key::I },
                { KEYBOARD_J, Index::InputCode::Key::J },
                { KEYBOARD_K, Index::InputCode::Key::K },
                { KEYBOARD_L, Index::InputCode::Key::L },
                { KEYBOARD_M, Index::InputCode::Key::M },
                { KEYBOARD_N, Index::InputCode::Key::N },
                { KEYBOARD_O, Index::InputCode::Key::O },
                { KEYBOARD_P, Index::InputCode::Key::P },
                { KEYBOARD_Q, Index::InputCode::Key::Q },
                { KEYBOARD_R, Index::InputCode::Key::R },
                { KEYBOARD_S, Index::InputCode::Key::S },
                { KEYBOARD_T, Index::InputCode::Key::T },
                { KEYBOARD_U, Index::InputCode::Key::U },
                { KEYBOARD_V, Index::InputCode::Key::V },
                { KEYBOARD_W, Index::InputCode::Key::W },
                { KEYBOARD_X, Index::InputCode::Key::X },
                { KEYBOARD_Y, Index::InputCode::Key::Y },
                { KEYBOARD_Z, Index::InputCode::Key::Z },

                { KEYBOARD_0, Index::InputCode::Key::D0 },
                { KEYBOARD_1, Index::InputCode::Key::D1 },
                { KEYBOARD_2, Index::InputCode::Key::D2 },
                { KEYBOARD_3, Index::InputCode::Key::D3 },
                { KEYBOARD_4, Index::InputCode::Key::D4 },
                { KEYBOARD_5, Index::InputCode::Key::D5 },
                { KEYBOARD_6, Index::InputCode::Key::D6 },
                { KEYBOARD_7, Index::InputCode::Key::D7 },
                { KEYBOARD_8, Index::InputCode::Key::D8 },
                { KEYBOARD_9, Index::InputCode::Key::D9 },

                { KEYBOARD_SUBTRACT, Index::InputCode::Key::Minus },
                { KEYBOARD_DELETE, Index::InputCode::Key::Delete },
                { KEYBOARD_SPACE, Index::InputCode::Key::Space },
                { KEYBOARD_LEFT, Index::InputCode::Key::Left },
                { KEYBOARD_RIGHT, Index::InputCode::Key::Right },
                { KEYBOARD_UP, Index::InputCode::Key::Up },
                { KEYBOARD_DOWN, Index::InputCode::Key::Down },
                { KEYBOARD_LSHIFT, Index::InputCode::Key::LeftShift },
                { KEYBOARD_RSHIFT, Index::InputCode::Key::RightShift },
                { KEYBOARD_LCONTROL, Index::InputCode::Key::LeftControl },
                { KEYBOARD_RCONTROL, Index::InputCode::Key::RightControl },
                { KEYBOARD_LWIN, Index::InputCode::Key::LeftSuper },
                { KEYBOARD_RWIN, Index::InputCode::Key::RightSuper },
                { KEYBOARD_LMENU, Index::InputCode::Key::Menu },
                { KEYBOARD_ESCAPE, Index::InputCode::Key::Escape },
                { KEYBOARD_ADD, Index::InputCode::Key::Equal },
                { KEYBOARD_BACK, Index::InputCode::Key::Backspace },
                { KEYBOARD_RETURN, Index::InputCode::Key::Enter },
                { KEYBOARD_COMMA, Index::InputCode::Key::Comma }
            };
