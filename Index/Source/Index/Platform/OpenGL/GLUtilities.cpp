...
namespace Index
{
    namespace Graphics
    {
        uint32_t GLUtilities::FormatToGL(const RHIFormat format, bool srgb)
        {
            ...
            default:
                INDEX_ASSERT(false, "[Texture] Unsupported Format");
                return 0;
            }
        }
        ...
        uint32_t GLUtilities::TextureWrapToGL(const TextureWrap wrap)
        {
            ...
            default:
                INDEX_ASSERT(false, "[Texture] Unsupported TextureWrap");
                return 0;
            }
        }
        ...
        uint32_t GLUtilities::FormatToInternalFormat(uint32_t format)
        {
            ...
            default:
                INDEX_ASSERT(false, "[Texture] Unsupported Texture Format");
                return 0;
            }
        }
        ...
        uint32_t GLUtilities::StencilTypeToGL(const StencilType type)
        {
            ...
            case StencilType::ALWAYS:
                return GL_ALWAYS;
            default:
                INDEX_ASSERT(false, "Unsupported StencilType");
                return 0;
            }
        }
        ...
        uint32_t GLUtilities::DataTypeToGL(DataType dataType)
        {
            ...
            case DataType::UNSIGNED_BYTE:
                return GL_UNSIGNED_BYTE;
            default:
                INDEX_LOG_ERROR("Unsupported DataType");
                break;
            }
            return 0;
        }
        ...
        uint32_t GLUtilities::DrawTypeToGL(DrawType drawType)
        {
            ...
            case DrawType::TRIANGLE:
                return GL_TRIANGLES;
            default:
                INDEX_LOG_ERROR("Unsupported DrawType");
                break;
            }
            return 0;
        }
