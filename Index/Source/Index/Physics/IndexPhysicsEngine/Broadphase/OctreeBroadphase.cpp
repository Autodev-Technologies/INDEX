...
namespace Index
{
                                                       ...
                                                       std::vector<CollisionPair>& collisionPairs)
    {
        ...
        for(uint32_t i = 0; i < objectCount; i++)
        {
            ...
            {
                INDEX_PROFILE_SCOPE("Merge Bounding box and add Physics Object");
    ...
    void OctreeBroadphase::Divide(OctreeNode& division, const size_t iteration)
    {
        ...
        {
            INDEX_PROFILE_SCOPE("Create Child");
            ...
            {
                INDEX_PROFILE_SCOPE("PhysicsObject BB check");
