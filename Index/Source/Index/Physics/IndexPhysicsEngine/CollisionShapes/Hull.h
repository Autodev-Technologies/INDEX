...
namespace Index
{
    ...
    struct INDEX_EXPORT HullVertex
    {
        int idx = 0;
        glm::vec3 pos;
    ...
    public:
        ...
        void AddFace(const glm::vec3& normal, const std::vector<int>& vert_ids) { AddFace(normal, static_cast<int>(vert_ids.size()), &vert_ids[0]); }
