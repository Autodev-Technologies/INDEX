...
namespace Index
{
    ...
    struct INDEX_EXPORT CollisionEdge
    {
    ...
    class INDEX_EXPORT CollisionShape
    {
    public:
        CollisionShape()
            : m_Type()
        ...
        {
            INDEX_LOG_ERROR("Loading abstract CollisionShape");
        }

        template <class Archive>
        void save(Archive& archive) const
        {
            INDEX_LOG_ERROR("Serialising abstract CollisionShape");
        }
