#pragma once
#include "Physics/IndexPhysicsEngine/CollisionShapes/CollisionShape.h"
#include "Physics/IndexPhysicsEngine/CollisionShapes/SphereCollisionShape.h"
#include "Physics/IndexPhysicsEngine/CollisionShapes/CuboidCollisionShape.h"
#include "Physics/IndexPhysicsEngine/CollisionShapes/PyramidCollisionShape.h"
#include "Physics/IndexPhysicsEngine/CollisionShapes/HullCollisionShape.h"
#include "Physics/IndexPhysicsEngine/CollisionShapes/CapsuleCollisionShape.h"
...
CEREAL_REGISTER_TYPE(Index::SphereCollisionShape);
CEREAL_REGISTER_TYPE(Index::CuboidCollisionShape);
CEREAL_REGISTER_TYPE(Index::PyramidCollisionShape);
CEREAL_REGISTER_TYPE(Index::HullCollisionShape);
CEREAL_REGISTER_TYPE(Index::CapsuleCollisionShape);

CEREAL_REGISTER_POLYMORPHIC_RELATION(Index::CollisionShape, Index::SphereCollisionShape);
CEREAL_REGISTER_POLYMORPHIC_RELATION(Index::CollisionShape, Index::CuboidCollisionShape);
CEREAL_REGISTER_POLYMORPHIC_RELATION(Index::CollisionShape, Index::PyramidCollisionShape);
CEREAL_REGISTER_POLYMORPHIC_RELATION(Index::CollisionShape, Index::HullCollisionShape);
CEREAL_REGISTER_POLYMORPHIC_RELATION(Index::CollisionShape, Index::CapsuleCollisionShape);

namespace Index
{
    class IndexPhysicsEngine;
    class Manifold;
    ...
    class INDEX_EXPORT RigidBody3D
    {
        friend class IndexPhysicsEngine;
    ...
    public:
        ...
        {
            INDEX_ASSERT(v > 0, "Physics object mass <= 0");
            m_InvMass = 1.0f / v;
