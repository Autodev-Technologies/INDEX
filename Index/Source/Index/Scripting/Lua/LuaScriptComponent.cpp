...
namespace Index
{
    ...
    void LuaScriptComponent::LoadScript(const std::string& fileName)
    {
        ...
        {
            INDEX_LOG_ERROR("Failed to Load Lua script {0}", fileName);
            m_Env = nullptr;
            return;
        }
        ...
        if(!loadFileResult.valid())
        {
            ...
            INDEX_LOG_ERROR("Failed to Execute Lua script {0}", physicalPath);
            INDEX_LOG_ERROR("Error : {0}", err.what());
    ...
    void LuaScriptComponent::OnInit()
    {
        if(m_OnInitFunc)
        {
            ...
            if(!result.valid())
            {
                ...
                INDEX_LOG_ERROR("Failed to Execute Script Lua Init function");
                INDEX_LOG_ERROR("Error : {0}", err.what());
            }
        }
    }
    ...
    void LuaScriptComponent::OnUpdate(float dt)
    {
        if(m_UpdateFunc)
        {
            ...
            {
                sol::error err = result;
                INDEX_LOG_ERROR("Failed to Execute Script Lua OnUpdate");
                INDEX_LOG_ERROR("Error : {0}", err.what());
            }
        }
    }
    ...
    void LuaScriptComponent::OnCollision2DBegin()
    {
        if(m_Phys2DBeginFunc)
        {
            ...
            {
                sol::error err = result;
                INDEX_LOG_ERROR("Failed to Execute Script Lua OnCollision2DBegin");
                INDEX_LOG_ERROR("Error : {0}", err.what());
            }
        }
    }
    ...
    void LuaScriptComponent::OnCollision2DEnd()
    {
        if(m_Phys2DEndFunc)
        {
            ...
            {
                sol::error err = result;
                INDEX_LOG_ERROR("Failed to Execute Script Lua OnCollision2DEnd");
                INDEX_LOG_ERROR("Error : {0}", err.what());
            }
        }
    }
    ...
    void LuaScriptComponent::OnCollision3DBegin()
    {
        if(m_Phys3DBeginFunc)
        {
            ...
            {
                sol::error err = result;
                INDEX_LOG_ERROR("Failed to Execute Script Lua OnCollision3DBegin");
                INDEX_LOG_ERROR("Error : {0}", err.what());
            }
        }
    }
    ...
    void LuaScriptComponent::OnCollision3DEnd()
    {
        if(m_Phys3DEndFunc)
        {
            ...
            {
                sol::error err = result;
                INDEX_LOG_ERROR("Failed to Execute Script Lua OnCollision3DEnd");
                INDEX_LOG_ERROR("Error : {0}", err.what());
            }
        }
    }
